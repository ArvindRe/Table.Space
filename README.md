...
Shell script suite for end-to-end Oracle Data Pump orchestration on Exadata. Covers parfile generation, job monitoring, log archiving, dumpfile cleanup, ZFS replication management, and large-scale parallel exports. Tested on Oracle 19c RAC/Exadata.
